...
if not os.environ.get('CI'):
    # As of 2024-05-21, US IP addresses are banned for legal reasons by the Binance API endpoint.
    # Unfortunately, GitHub actions run on US servers and we have currently no option to change
    # that.
    # For now, simply disable Binance API tests when run in a CI environment :/
